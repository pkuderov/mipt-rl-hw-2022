...
def sample_trajectories(env, policy, min_timesteps_per_batch, 
    ...
    """
        ...
        Hint1: use sample_trajectory to get each path (i.e. rollout) 
                                                            that goes into paths
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        ...
        #DEBUG
        print(timesteps_this_batch / min_timesteps_per_batch)
...
def convert_listofrollouts(paths, concat_rew=True):
    """
        ...
        where each array is a concatenation of that array from across 
                                                                  the rollouts
    """
